...
ct triste "Pois é, nosso campus ainda tem problemas de acessibilidade, mas tenho certeza que algo está será feito a respeito"

ct feliz "Mas vamos falar de coisas felizes! Há tantos laboratórios para conhecer! Tenho certeza que todos estarão de braços abertos para nos receber!"
...
ct "Os laboratórios abrem processos seletivos periodicamente, mas é interessante buscar serviços voluntários" "falar com os professores responsáveis de cada laboratório é uma boa ideia" "Você pode achar várias informações nas redes sociais"
